...
$(VIM_RUNTIME_R): $(LOCAL_INSTALLED_MODULE)
	@echo ${CL_CYN}"Install: $(VIM_SHARED)/"${CL_RST}
	@mkdir -p $(VIM_SHARED)
	$(hide) cp $@ $(VIM_SHARED)/
...
$(VIM_RUNTIME_C): $(LOCAL_INSTALLED_MODULE)
	@echo ${CL_CYN}"Install: $(VIM_SHARED)/colors/"${CL_RST}
...
$(VIM_RUNTIME_D): $(LOCAL_INSTALLED_MODULE)
	@echo ${CL_CYN}"Install: $(VIM_SHARED)/doc/"${CL_RST}
...
$(VIM_RUNTIME_S): $(LOCAL_INSTALLED_MODULE)
	@echo ${CL_CYN}"Install: $(VIM_SHARED)/syntax/"${CL_RST}
...
$(VIM_RUNTIME_P): $(LOCAL_INSTALLED_MODULE)
	@echo ${CL_CYN}"Install: $(VIM_SHARED)/plugin/"${CL_RST}
...
$(VIM_RUNTIME_A): $(LOCAL_INSTALLED_MODULE)
	@echo ${CL_CYN}"Install: $(VIM_SHARED)/autoload/"${CL_RST}
