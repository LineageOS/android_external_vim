...
VIM_RUNTIME_R := $(vim_runtime_files)
$(VIM_RUNTIME_R): $(LOCAL_INSTALLED_MODULE)
	@echo -e ${CL_CYN}"Install: $(VIM_SHARED)/$@"${CL_RST}
	@mkdir -p $(VIM_SHARED)
	$(hide) cp $(addprefix $(vim_runtime_path)/,$@) $(VIM_SHARED)/

ALL_DEFAULT_INSTALLED_MODULES += $(VIM_RUNTIME_R)


VIM_RUNTIME_C := $(vim_colors_files)
$(VIM_RUNTIME_C): $(LOCAL_INSTALLED_MODULE)
	@echo -e ${CL_CYN}"Install: $(VIM_SHARED)/colors/$@"${CL_RST}
	@mkdir -p $(VIM_SHARED)/colors
	$(hide) cp $(addprefix $(vim_runtime_path)/colors/,$@) $(VIM_SHARED)/colors/

ALL_DEFAULT_INSTALLED_MODULES += $(VIM_RUNTIME_C)


VIM_RUNTIME_D := $(vim_doc_files)
$(VIM_RUNTIME_D): $(LOCAL_INSTALLED_MODULE)
	@echo -e ${CL_CYN}"Install: $(VIM_SHARED)/doc/$@"${CL_RST}
	@mkdir -p $(VIM_SHARED)/doc
	$(hide) cp $(addprefix $(vim_runtime_path)/doc/,$@) $(VIM_SHARED)/doc/

ALL_DEFAULT_INSTALLED_MODULES += $(VIM_RUNTIME_D)


VIM_RUNTIME_S := $(vim_syntax_files)
$(VIM_RUNTIME_S): $(LOCAL_INSTALLED_MODULE)
	@echo -e ${CL_CYN}"Install: $(VIM_SHARED)/syntax/$@"${CL_RST}
	@mkdir -p $(VIM_SHARED)/syntax
	$(hide) cp $(addprefix $(vim_runtime_path)/syntax/,$@) $(VIM_SHARED)/syntax/

ALL_DEFAULT_INSTALLED_MODULES += $(VIM_RUNTIME_S)


VIM_RUNTIME_P := $(vim_plugin_files)
$(VIM_RUNTIME_P): $(LOCAL_INSTALLED_MODULE)
	@echo -e ${CL_CYN}"Install: $(VIM_SHARED)/plugin/$@"${CL_RST}
	@mkdir -p $(VIM_SHARED)/plugin
	$(hide) cp $(addprefix $(vim_runtime_path)/plugin/,$@) $(VIM_SHARED)/plugin/

ALL_DEFAULT_INSTALLED_MODULES += $(VIM_RUNTIME_P)


VIM_RUNTIME_A := $(vim_autoload_files)
$(VIM_RUNTIME_A): $(LOCAL_INSTALLED_MODULE)
	@echo -e ${CL_CYN}"Install: $(VIM_SHARED)/autoload/$@"${CL_RST}
	@mkdir -p $(VIM_SHARED)/autoload
	$(hide) cp $(addprefix $(vim_runtime_path)/autoload/,$@) $(VIM_SHARED)/autoload/
